...
let SHA256 = (s) => {
    ...
    let Sigma0256 = (x) => (S(x, 2) ^ S(x, 13) ^ S(x, 22));

    let Sigma1256 = (x) => (S(x, 6) ^ S(x, 11) ^ S(x, 25));

    let Gamma0256 = (x) => (S(x, 7) ^ S(x, 18) ^ R(x, 3));

    let Gamma1256 = (x) => (S(x, 17) ^ S(x, 19) ^ R(x, 10));
